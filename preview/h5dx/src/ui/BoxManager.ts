...
class BoxManager {
     ...
     * For custom levels, always returns 1 (where the dummy box is created, box 0 has unique theming).
     */
    ...
    static loadBoxes(): void {
        ...
        // Always use getDefaultBoxIndex() to ensure custom levels use index 0
