...
import { hide, append, empty, show } from "@/utils/domHelpers";
    ...
    onShowPanel(panelId: PanelIdType): void {
        ...
        switch (panelId) {
            ...
            case PanelId.GAME:
                ...
                // Show game UI buttons when returning to game
                show("#gameBtnTray");
                break;

            case PanelId.GAMEMENU:
                // Show game UI buttons when returning to game menu (e.g., from options)
                // The game is still active, so the UI should be visible
                show("#gameBtnTray");
                break;
            ...
            case PanelId.OPTIONS:
                ...
                // Hide game UI buttons while in settings menu
                hide("#gameBtnTray");
                break;
